...
//?if database is not existing, open database otherwise return old Database
  ...
  String colId = 'id'; //Column Name
  String colTitle = 'title';
  String colDescription = 'description';
  String colPriority = 'priority';
  String colDate = 'date';

  //TODODidnt Understand
  factory DatabaseHelper() {
    //Factory Constructor returns value
